...
The features and specifications for {{site.data.keyword.Db2_on_Cloud_long}} for Amazon Web Services are summarized here for your convenience.
{: shortdesc}
...
| Data center location options | N | Only US East at this time |
